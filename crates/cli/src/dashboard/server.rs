...
use super::product_api::{
    compatible_dataset_list_api, demo_run_action_api, demo_run_create_api, demo_run_snapshot_api,
    live_account_refresh_api, live_admission_api, live_execution_cancel_operator_approval_api,
...
fn dashboard_router_with_workflow_root(
    ...
    let product_routes = Router::new()
        ...
        .route(
            "/api/product/v1/strategies/{strategy_id}/versions",
            get(strategy_version_list_api)
                .head(product_method_not_allowed)
                .fallback(product_method_not_allowed),
        )
        .route(
        ...
        .route(
            "/api/product/v1/strategies/{strategy_id}/versions/{version_id}/datasets",
            get(compatible_dataset_list_api)
                .head(product_method_not_allowed)
                .fallback(product_method_not_allowed),
        )
        .route(
            "/api/product/v1/strategies/{strategy_id}/versions/{version_id}/live-admission",
            get(live_admission_api)
                .head(product_method_not_allowed)
                .fallback(product_method_not_allowed),
        )
        .route(
        ...
        .route(
            "/api/product/v1/runs/{run_id}/demo-snapshot",
            get(demo_run_snapshot_api)
                .head(product_method_not_allowed)
                .fallback(product_method_not_allowed),
        )
        .route(
            "/api/product/v1/runs/{run_id}/metrics",
            get(run_metrics_api)
                .head(product_method_not_allowed)
                .fallback(product_method_not_allowed),
        )
        .route(
            "/api/product/v1/runs/{run_id}/report",
            get(run_report_api)
                .head(product_method_not_allowed)
                .fallback(product_method_not_allowed),
        )
        .route(
            "/api/product/v1/runs/{run_id}/analysis",
