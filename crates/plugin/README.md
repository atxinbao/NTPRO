...
state, host custom-data callbacks that are not backed by a plug-in vtable, and
hot reload of any plug-in while the live node is running. Plug-ins load at
process startup and live for the process lifetime.
