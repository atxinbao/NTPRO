...
impl EncodeToRecordBatch for FuturesContract {
    fn encode_batch(
        ...
        for fc in data {
            ...
            currency_builder.append_value(fc.currency.to_string());
            price_precision_builder.append_value(fc.price_precision);
            size_precision_builder.append_value(fc.size_precision);
            price_increment_builder.append_value(fc.price_increment.to_string());
            size_increment_builder.append_value(fc.size_increment.to_string());
            multiplier_builder.append_value(fc.multiplier.to_string());
            ...
            ts_event_builder.append_value(fc.ts_event.as_u64());
...
pub fn decode_futures_contract_batch(
    ...
    let currency_values = extract_column::<StringArray>(cols, "currency", 5, DataType::Utf8)?;
    ...
    let lot_size_values = extract_column::<StringArray>(cols, "lot_size", 11, DataType::Utf8)?;
