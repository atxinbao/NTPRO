...
v0.28.1 is ready for tag-gate execution when V281-001 through V281-010 evidence
...
要求 V281-001 到 V281-010 全部闭环，hosted release gate 成功后再公开 GitHub Release。
...
V281-009 evidence = docs/rust-cutover/evidence/V281-009.md
V281-010 evidence = docs/rust-cutover/evidence/V281-010.md
