# RPROD-004 - Implement or close backtest CLI entrypoint gaps
...
Implement or close backtest CLI entrypoint gaps

## Scope

Implement missing backtest CLI command or record scoped blocker with evidence
...
Create `docs/rust-cutover/evidence/RPROD-004.md` with:
