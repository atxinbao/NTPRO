# RTRACE-003 - Capture order lifecycle trace fixtures
...
Capture order lifecycle trace fixtures

## Scope

Add order lifecycle fixtures for Rust replay or schema validation
...
Create `docs/rust-cutover/evidence/RTRACE-003.md` with:
