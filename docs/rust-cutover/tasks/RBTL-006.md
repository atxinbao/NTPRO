# RBTL-006 - Add Rust LiveNode lifecycle smoke
...
Add Rust LiveNode lifecycle smoke

## Scope

Add/run Rust LiveNode construction/start/stop smoke without Python
...
Create `docs/rust-cutover/evidence/RBTL-006.md` with:
