# RADP-005 - Add Rust adapter fixtures for Bybit OKX Kraken
...
Add Rust adapter fixtures for Bybit OKX Kraken

## Scope

Add parser/lifecycle fixtures for Bybit OKX Kraken
...
Bybit OKX Kraken Rust fixtures or scoped blockers exist
...
Create `docs/rust-cutover/evidence/RADP-005.md` with:
