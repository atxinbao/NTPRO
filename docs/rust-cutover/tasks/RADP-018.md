# RADP-018 - Close Rust adapter gaps for Interactive Brokers
...
Close Rust adapter gaps for Interactive Brokers

## Scope

Implement or scope Rust-only adapter gaps for Interactive Brokers
...
Interactive Brokers adapter parity resolved or explicitly scoped with evidence
...
Create `docs/rust-cutover/evidence/RADP-018.md` with:
