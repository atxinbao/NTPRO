# RCORE-015 - Close Rust portfolio/accounting/PnL gaps
...
Close Rust portfolio/accounting/PnL gaps

## Scope

Implement or scope remaining Rust-only gaps for portfolio/accounting/PnL
...
portfolio/accounting/PnL parity is implemented or explicitly scoped with evidence
...
Create `docs/rust-cutover/evidence/RCORE-015.md` with:
