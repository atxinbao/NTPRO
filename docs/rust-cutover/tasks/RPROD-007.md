# RPROD-007 - Define data/catalog CLI contract
...
Define data/catalog CLI contract

## Scope

Specify data/catalog inspect, validate, and load workflows
...
Create `docs/rust-cutover/evidence/RPROD-007.md` with:
