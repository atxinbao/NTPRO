# RPROD-005 - Define live or sandbox run CLI contract
...
Define live or sandbox run CLI contract

## Scope

Specify live/sandbox run inputs, config format, lifecycle, and shutdown behavior
...
Create `docs/rust-cutover/evidence/RPROD-005.md` with:
