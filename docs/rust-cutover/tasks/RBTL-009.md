# RBTL-009 - Prove backtest/live semantic parity
...
Prove backtest/live semantic parity

## Scope

Compare Rust backtest and live/sandbox behavior for scoped trace categories
...
Create `docs/rust-cutover/evidence/RBTL-009.md` with:
