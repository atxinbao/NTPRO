# RADP-001 - Inventory Rust adapter gaps for Binance
...
Inventory Rust adapter gaps for Binance

## Scope

Inspect crates/adapters/binance/ for Rust-only parser, data, and execution gaps
...
Binance Rust adapter gap list exists
...
Create `docs/rust-cutover/evidence/RADP-001.md` with:
