# RPROD-010 - Add Rust examples layout
...
Add Rust examples layout

## Scope

Create or normalize examples/rust with supported workflows
...
Create `docs/rust-cutover/evidence/RPROD-010.md` with:
