# RTRACE-007 - Bind adapter payload trace fixtures
...
Bind adapter payload trace fixtures

## Scope

Validate at least one adapter payload fixture through Rust parser code
...
Create `docs/rust-cutover/evidence/RTRACE-007.md` with:
