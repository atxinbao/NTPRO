# RPROD-011 - Add Rust backtest example smoke
...
Add Rust backtest example smoke

## Scope

Run at least one Rust backtest example from Cargo
...
Create `docs/rust-cutover/evidence/RPROD-011.md` with:
