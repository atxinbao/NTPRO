# RCORE-006 - Close Rust serialization/data/persistence gaps
...
Close Rust serialization/data/persistence gaps

## Scope

Implement or scope remaining Rust-only gaps for serialization/data/persistence
...
serialization/data/persistence parity is implemented or explicitly scoped with evidence
...
Create `docs/rust-cutover/evidence/RCORE-006.md` with:
