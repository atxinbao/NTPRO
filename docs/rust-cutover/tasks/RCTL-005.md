# RCTL-005 - Create Rust-only scope decision log
...
Create Rust-only scope decision log

## Scope

Create docs/rust-cutover/scope/SCOPE_DECISIONS.md with owner decision format
...
Create `docs/rust-cutover/evidence/RCTL-005.md` with:
