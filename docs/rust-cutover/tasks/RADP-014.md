# RADP-014 - Add Rust adapter fixtures for Databento Tardis
...
Add Rust adapter fixtures for Databento Tardis

## Scope

Add parser/lifecycle fixtures for Databento Tardis
...
Databento Tardis Rust fixtures or scoped blockers exist
...
Create `docs/rust-cutover/evidence/RADP-014.md` with:
