# RADP-002 - Add Rust adapter fixtures for Binance
...
Add Rust adapter fixtures for Binance

## Scope

Add parser/lifecycle fixtures for Binance
...
Binance Rust fixtures or scoped blockers exist
...
Create `docs/rust-cutover/evidence/RADP-002.md` with:
