# RPROD-006 - Implement or close live/sandbox CLI entrypoint gaps
...
Implement or close live/sandbox CLI entrypoint gaps

## Scope

Implement missing live/sandbox CLI command or record scoped blocker with evidence
...
Create `docs/rust-cutover/evidence/RPROD-006.md` with:
