# RCTL-003 - Install task execution and lease protocol
...
Install task execution and lease protocol

## Scope

Install task execution docs, evidence template, and lease workflow
...
Create `docs/rust-cutover/evidence/RCTL-003.md` with:
