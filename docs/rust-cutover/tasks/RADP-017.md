# RADP-017 - Add Rust adapter fixtures for Interactive Brokers
...
Add Rust adapter fixtures for Interactive Brokers

## Scope

Add parser/lifecycle fixtures for Interactive Brokers
...
Interactive Brokers Rust fixtures or scoped blockers exist
...
Create `docs/rust-cutover/evidence/RADP-017.md` with:
