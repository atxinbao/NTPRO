# RREL-002 - Write Rust-only release notes
...
Write Rust-only release notes

## Scope

Write release notes with breaking changes and replacement workflows
...
Create `docs/rust-cutover/evidence/RREL-002.md` with:
