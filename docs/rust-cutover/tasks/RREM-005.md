# RREM-005 - Port or scope Python-only tests
...
Port or scope Python-only tests

## Scope

Port required Python-only coverage to Rust tests or record approved scope decisions
...
Create `docs/rust-cutover/evidence/RREM-005.md` with:
