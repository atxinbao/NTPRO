# RTRACE-006 - Bind live/sandbox lifecycle trace
...
Bind live/sandbox lifecycle trace

## Scope

Run one live/sandbox lifecycle trace through Rust or record scoped blocker
...
Create `docs/rust-cutover/evidence/RTRACE-006.md` with:
