# RADP-023 - Add Rust adapter fixtures for Polymarket Sandbox
...
Add Rust adapter fixtures for Polymarket Sandbox

## Scope

Add parser/lifecycle fixtures for Polymarket Sandbox
...
Polymarket Sandbox Rust fixtures or scoped blockers exist
...
Create `docs/rust-cutover/evidence/RADP-023.md` with:
