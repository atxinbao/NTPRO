# RREM-004 - Map Python workflows to Rust workflows
...
Map Python workflows to Rust workflows

## Scope

Document Rust CLI/example replacements for supported Python workflows
...
Create `docs/rust-cutover/evidence/RREM-004.md` with:
