# RBTL-008 - Add Rust sandbox execution smoke
...
Add Rust sandbox execution smoke

## Scope

Add/run Rust sandbox execution smoke or record scoped blocker
...
Create `docs/rust-cutover/evidence/RBTL-008.md` with:
