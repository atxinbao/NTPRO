# RADP-009 - Close Rust adapter gaps for Coinbase BitMEX
...
Close Rust adapter gaps for Coinbase BitMEX

## Scope

Implement or scope Rust-only adapter gaps for Coinbase BitMEX
...
Coinbase BitMEX adapter parity resolved or explicitly scoped with evidence
...
Create `docs/rust-cutover/evidence/RADP-009.md` with:
