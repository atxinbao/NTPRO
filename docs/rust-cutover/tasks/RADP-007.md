# RADP-007 - Inventory Rust adapter gaps for Coinbase BitMEX
...
Inventory Rust adapter gaps for Coinbase BitMEX

## Scope

Inspect crates/adapters/coinbase/ and crates/adapters/bitmex/ for Rust-only parser, data, and execution gaps
...
Coinbase BitMEX Rust adapter gap list exists
...
Create `docs/rust-cutover/evidence/RADP-007.md` with:
