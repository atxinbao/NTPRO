# RCTL-006 - Install PR and issue templates
...
Install PR and issue templates

## Scope

Install Rust-only PR checklist and task issue template
...
Create `docs/rust-cutover/evidence/RCTL-006.md` with:
