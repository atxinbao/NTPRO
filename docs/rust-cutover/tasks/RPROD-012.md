# RPROD-012 - Add Rust live or sandbox example smoke
...
Add Rust live or sandbox example smoke

## Scope

Run or construct at least one Rust live/sandbox node flow without Python
...
Create `docs/rust-cutover/evidence/RPROD-012.md` with:
