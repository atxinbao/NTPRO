# RADP-012 - Close Rust adapter gaps for Deribit dYdX Hyperliquid
...
Close Rust adapter gaps for Deribit dYdX Hyperliquid

## Scope

Implement or scope Rust-only adapter gaps for Deribit dYdX Hyperliquid
...
Deribit dYdX Hyperliquid adapter parity resolved or explicitly scoped with evidence
...
Create `docs/rust-cutover/evidence/RADP-012.md` with:
