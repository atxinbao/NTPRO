# RADP-011 - Add Rust adapter fixtures for Deribit dYdX Hyperliquid
...
Add Rust adapter fixtures for Deribit dYdX Hyperliquid

## Scope

Add parser/lifecycle fixtures for Deribit dYdX Hyperliquid
...
Deribit dYdX Hyperliquid Rust fixtures or scoped blockers exist
...
Create `docs/rust-cutover/evidence/RADP-011.md` with:
