# RCORE-002 - Add Rust tests for core/model value types
...
Add Rust tests for core/model value types

## Scope

Add or identify Rust tests covering core/model value types
...
Rust tests for core/model value types exist or blocker is scoped
...
Create `docs/rust-cutover/evidence/RCORE-002.md` with:
