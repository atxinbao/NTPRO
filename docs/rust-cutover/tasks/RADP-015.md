# RADP-015 - Close Rust adapter gaps for Databento Tardis
...
Close Rust adapter gaps for Databento Tardis

## Scope

Implement or scope Rust-only adapter gaps for Databento Tardis
...
Databento Tardis adapter parity resolved or explicitly scoped with evidence
...
Create `docs/rust-cutover/evidence/RADP-015.md` with:
