# RREM-001 - Inventory Python product surfaces
...
Inventory Python product surfaces

## Scope

Inventory python/, top-level nautilus_trader/, Python examples, Python tests, and docs that are product-facing
...
Create `docs/rust-cutover/evidence/RREM-001.md` with:
