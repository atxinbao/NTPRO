...
| --- | --- | --- |
| `IGN-EXEC-001` through `IGN-EXEC-003` | `SCOPED_OUT_FOR_V04`; still open for matching-engine hardening. | v0.4 uses a deterministic mock Binance order lifecycle and does not claim production matching-engine contingent/OCO/trailing-stop semantics. |
