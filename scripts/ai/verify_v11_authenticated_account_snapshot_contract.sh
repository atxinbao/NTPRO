...
grep -q '"contract_ready": false' "$BLOCKED_JSON"
grep -q '"online_read_allowed": false' "$BLOCKED_JSON"
...
grep -q '"contract_ready": false' "$MISSING_CREDENTIALS_JSON"
grep -q '"online_read_allowed": false' "$MISSING_CREDENTIALS_JSON"
...
grep -q '"contract_ready": true' "$READY_JSON"
grep -q '"online_read_allowed": false' "$READY_JSON"
