...
echo "current governance gate: use scripts/ai/verify_release.sh current-governance backend-freeze-baseline"
...
echo "== verify_fast complete: fast smoke only; current release governance still requires verify_release.sh =="
