...
echo "strict provenance gate: use scripts/ai/verify_release_strict.sh v18, v19, v20, v21, or v22, plus scripts/ai/verify_release.sh v21.1-strict-provenance or v22.1-strict-provenance for patch releases"
