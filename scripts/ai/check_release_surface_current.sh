...
NEXT_PATCH_VERSION="${NTPRO_NEXT_PATCH_VERSION:-v0.23.1}"
NEXT_CAPABILITY_VERSION="${NTPRO_NEXT_CAPABILITY_VERSION:-v0.24.0}"
CURRENT_RELEASE_CAPABILITY="${NTPRO_CURRENT_RELEASE_CAPABILITY:-Multi-Account / Multi-Strategy / Multi-Venue Node Isolation}"
