...
NEXT_PATCH_VERSION="${NTPRO_NEXT_PATCH_VERSION:-v0.20.1}"
NEXT_CAPABILITY_VERSION="${NTPRO_NEXT_CAPABILITY_VERSION:-v0.21.0}"
CURRENT_RELEASE_CAPABILITY="${NTPRO_CURRENT_RELEASE_CAPABILITY:-Owner-Approved Production Order Lifecycle Foundation}"
