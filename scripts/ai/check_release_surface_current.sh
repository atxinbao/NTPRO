...
NEXT_PATCH_VERSION="${NTPRO_NEXT_PATCH_VERSION:-v0.22.2}"
NEXT_CAPABILITY_VERSION="${NTPRO_NEXT_CAPABILITY_VERSION:-v0.23.0}"
CURRENT_RELEASE_CAPABILITY="${NTPRO_CURRENT_RELEASE_CAPABILITY:-Trader Terminal Workbench Hardening Patch}"
