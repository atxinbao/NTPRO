...
NEXT_PATCH_VERSION="${NTPRO_NEXT_PATCH_VERSION:-v0.30.1}"
NEXT_CAPABILITY_VERSION="${NTPRO_NEXT_CAPABILITY_VERSION:-v0.31.0}"
CURRENT_RELEASE_CAPABILITY="${NTPRO_CURRENT_RELEASE_CAPABILITY:-v0.30.0 Backend Production Go-Live Candidate Foundation}"
