...
NEXT_PATCH_VERSION="${NTPRO_NEXT_PATCH_VERSION:-v0.16.1}"
NEXT_CAPABILITY_VERSION="${NTPRO_NEXT_CAPABILITY_VERSION:-v0.17.0}"
CURRENT_RELEASE_CAPABILITY="${NTPRO_CURRENT_RELEASE_CAPABILITY:-Minimum Owner-Approved Production Order Mutation Candidate}"
