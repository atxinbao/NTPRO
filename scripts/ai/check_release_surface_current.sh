...
NEXT_PATCH_VERSION="${NTPRO_NEXT_PATCH_VERSION:-v0.21.2}"
NEXT_CAPABILITY_VERSION="${NTPRO_NEXT_CAPABILITY_VERSION:-v0.22.0}"
CURRENT_RELEASE_CAPABILITY="${NTPRO_CURRENT_RELEASE_CAPABILITY:-Unified Read Model Foundation Hardening Patch}"
