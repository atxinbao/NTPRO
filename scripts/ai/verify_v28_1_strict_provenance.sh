...
require(release_manifest["task_id"] == "V281-007", "manifest task mismatch")
...
require(scope.get("exact_milestone_issue_numbers") == [919, 920, 921, 922, 923, 924, 925], "exact milestone issue numbers mismatch")
require(scope.get("exact_milestone_issue_set") == "#919-#925", "exact milestone issue set mismatch")
require(scope.get("final_release_scope_issue_count") == 7, "final release scope issue count mismatch")
require(scope.get("final_release_scope_evidence_count") == 7, "final release scope evidence count mismatch")
...
payload = {
    ...
    "v281_issue_scope": [919, 920, 921, 922, 923, 924, 925],
    ...
    "failure_paths": {
        ...
        "open_v281_issue": "NTPRO_RELEASE_GATE=1 fails unless V281 issues #919-#925 are closed",
