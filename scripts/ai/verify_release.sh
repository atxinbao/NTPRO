...
run_v291_release_closeout_evidence() {
  echo "== verify_release: v0.29.1 release closeout evidence =="
...
run_stage() {
  ...
  case "$stage" in
    ...
    v29-strict-provenance)
      run_v29_strict_provenance
      ;;
    v29.1-release-closeout-evidence)
      run_v291_release_closeout_evidence
      ;;
    v25-intake-gate)
      run_v25_intake_gate
