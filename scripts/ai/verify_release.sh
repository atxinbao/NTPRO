...
run_stage() {
  ...
  case "$stage" in
    ...
    *)
      ...
      echo "additional v28 stages: v28-trader-terminal-backend-api-contract-handoff, v28-backend-closure-fail-closed-hardening, v28-release-gates, v28-strict-provenance, v28.1-runtime-closed-terminology, v28.1-release-publish-after-gate-current-binding" >&2
      exit 2
      ;;
  esac
}
