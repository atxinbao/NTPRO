...
run_v171_release_hardening() {
  ...
  ensure_release_cli_binaries
  NTPRO_V171_SKIP_BUILD=1 \
    NTPRO_V171_NAUTILUS_BIN="$NAUTILUS_RELEASE_BIN" \
    NTPRO_V171_NTPRO_NODE_BIN="$NTPRO_NODE_RELEASE_BIN" \
