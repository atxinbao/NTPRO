...
run_v30_production_deployment_plan_environment_readiness() {
  echo "== verify_release: v0.30.0 production deployment plan environment readiness =="
...
run_v301_release_gates() {
  echo "== verify_release: v0.30.1 release gates =="
  scripts/ai/verify_v30_1_release_gates.sh
}

run_v301_strict_provenance() {
  echo "== verify_release: v0.30.1 strict provenance =="
...
run_v311_release_gates() {
  echo "== verify_release: v0.31.1 release gates =="
  scripts/ai/verify_v31_1_release_gates.sh
}

run_v311_strict_provenance() {
  echo "== verify_release: v0.31.1 strict provenance =="
  scripts/ai/verify_v31_1_strict_provenance.sh
}

run_v32_intake_gate() {
  echo "== verify_release: v0.32.0 intake gate =="
  scripts/ai/verify_v32_intake_gate.sh
}

run_v32_backend_closeout_boundary_contract() {
  echo "== verify_release: v0.32.0 backend closeout boundary contract =="
  scripts/ai/verify_v32_backend_closeout_boundary_contract.sh
}

run_v32_owner_operator_change_window_closeout() {
  echo "== verify_release: v0.32.0 owner/operator change-window closeout =="
  scripts/ai/verify_v32_owner_operator_change_window_closeout.sh
}

run_v32_risk_audit_go_no_go_closeout() {
  echo "== verify_release: v0.32.0 risk/audit/go-no-go closeout =="
  scripts/ai/verify_v32_risk_audit_go_no_go_closeout.sh
}

run_v32_config_venue_credential_provenance() {
  echo "== verify_release: v0.32.0 config/venue/credential provenance =="
  scripts/ai/verify_v32_config_venue_credential_provenance.sh
}

run_v32_canary_rollback_dr_closeout() {
  echo "== verify_release: v0.32.0 canary/rollback/DR closeout =="
  scripts/ai/verify_v32_canary_rollback_dr_closeout.sh
}

run_v32_telemetry_slo_incident_closeout() {
  echo "== verify_release: v0.32.0 telemetry/SLO/incident closeout =="
  scripts/ai/verify_v32_telemetry_slo_incident_closeout.sh
}

run_v32_backend_enable_read_model_admin_bridge_closeout() {
  echo "== verify_release: v0.32.0 backend enablement read-model/admin bridge closeout =="
  scripts/ai/verify_v32_backend_enablement_read_model_admin_bridge_closeout.sh
}

run_v32_fail_closed_negative_tests() {
  echo "== verify_release: v0.32.0 fail-closed negative tests =="
  scripts/ai/verify_v32_fail_closed_negative_tests.sh
}

run_v32_release_gates() {
  echo "== verify_release: v0.32.0 release gates =="
  scripts/ai/verify_v32_release_gates.sh
}

run_v32_strict_provenance() {
  echo "== verify_release: v0.32.0 strict provenance =="
  scripts/ai/verify_v32_strict_provenance.sh
}

run_backend_freeze_baseline() {
  echo "== verify_release: backend freeze baseline =="
...
run_stage() {
  ...
  case "$stage" in
    ...
    v31.1-release-gates)
      run_v311_release_gates
      ;;
    v31.1-strict-provenance)
      run_v311_strict_provenance
      ;;
    v32-intake-gate)
      run_v32_intake_gate
      ;;
    v32-backend-closeout-boundary-contract)
      run_v32_backend_closeout_boundary_contract
      ;;
    v32-owner-operator-change-window-closeout)
      run_v32_owner_operator_change_window_closeout
      ;;
    v32-risk-audit-go-no-go-closeout)
      run_v32_risk_audit_go_no_go_closeout
      ;;
    v32-config-venue-credential-provenance)
      run_v32_config_venue_credential_provenance
      ;;
    v32-canary-rollback-dr-closeout)
      run_v32_canary_rollback_dr_closeout
      ;;
    v32-telemetry-slo-incident-closeout)
      run_v32_telemetry_slo_incident_closeout
      ;;
    v32-backend-enable-read-model-admin-bridge-closeout)
      run_v32_backend_enable_read_model_admin_bridge_closeout
      ;;
    v32-fail-closed-negative-tests)
      run_v32_fail_closed_negative_tests
      ;;
    v32-release-gates)
      run_v32_release_gates
      ;;
    v32-strict-provenance)
      run_v32_strict_provenance
      ;;
    ...
    *)
      ...
      echo "additional v28/v29/v30/v32 stages: v28-trader-terminal-backend-api-contract-handoff, v28-backend-closure-fail-closed-hardening, v28-release-gates, v28-strict-provenance, v28.1-runtime-closed-terminology, v28.1-release-publish-after-gate-current-binding, v28.1-release-gates, v28.1-strict-provenance, v29-intake-gate, v29-backend-production-readiness-boundary-contract, v29-persistent-audit-storage-production-readiness, v29-telemetry-slo-ingestion-production-readiness, v29-permission-source-production-readiness, v29-read-only-backend-api-production-readiness, v29-deployment-config-runbook-production-readiness, v29-monitoring-alert-incident-production-readiness, v29-canary-rollback-dr-preflight-readiness, v29-backend-production-readiness-fail-closed-hardening, v29-release-gates, v29-strict-provenance, v30-intake-gate, v30-backend-go-live-candidate-boundary-contract, v30-production-deployment-plan-environment-readiness, v32-intake-gate, v32-backend-closeout-boundary-contract, v32-owner-operator-change-window-closeout, v32-risk-audit-go-no-go-closeout, v32-config-venue-credential-provenance, v32-canary-rollback-dr-closeout, v32-telemetry-slo-incident-closeout, v32-backend-enable-read-model-admin-bridge-closeout, v32-fail-closed-negative-tests, v32-release-gates, v32-strict-provenance, backend-freeze-baseline" >&2
      exit 2
      ;;
  esac
}
