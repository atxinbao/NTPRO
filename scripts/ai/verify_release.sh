...
run_v291_post_publication_closeout_gate() {
  echo "== verify_release: v0.29.1 post-publication closeout gate =="
...
run_stage() {
  ...
  case "$stage" in
    ...
    v29-strict-provenance)
      run_v29_strict_provenance
      ;;
    v29.1-post-publication-closeout-gate)
      run_v291_post_publication_closeout_gate
      ;;
    v25-intake-gate)
      run_v25_intake_gate
    ...
    *)
      ...
      echo "additional v28/v29 stages: v28-trader-terminal-backend-api-contract-handoff, v28-backend-closure-fail-closed-hardening, v28-release-gates, v28-strict-provenance, v28.1-runtime-closed-terminology, v28.1-release-publish-after-gate-current-binding, v28.1-release-gates, v28.1-strict-provenance, v29-intake-gate, v29-backend-production-readiness-boundary-contract, v29-persistent-audit-storage-production-readiness, v29-telemetry-slo-ingestion-production-readiness, v29-permission-source-production-readiness, v29-read-only-backend-api-production-readiness, v29-deployment-config-runbook-production-readiness, v29-monitoring-alert-incident-production-readiness, v29-canary-rollback-dr-preflight-readiness, v29-backend-production-readiness-fail-closed-hardening, v29-release-gates, v29-strict-provenance, v29.1-post-publication-closeout-gate" >&2
      exit 2
      ;;
  esac
}
